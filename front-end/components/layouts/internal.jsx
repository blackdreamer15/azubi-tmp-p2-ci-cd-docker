			...
			<div className="drawer-side">
				...
				<div className="flex flex-col justify-between min-h-screen">
					<ul className="menu p-4 w-64 min-h-full  text-primary ">
						<li className="mb-10">
							<div className="text-4xl text-gray-600">Jessy</div>
						</li>
						<li
							className={`rounded-lg  ${
								activeLink === "/" ? "sidebar-menu-active" : ""
							}`}
						>
						...
						<li
							className={`rounded-lg ${
								activeLink === "users" ? "sidebar-menu-active mt-4" : "mt-4"
							}`}
						>
							<Link href="/users/">
								<svg
					...
					<ul className="menu p-4 w-64 min-h-full text-primary ">
						<li
							className={`bg-transparent dropdown dropdown-top rounded-lg ${
								activeLink === "account" ? "sidebar-menu-active mt-20" : "mt-20"
							}`}
						>
